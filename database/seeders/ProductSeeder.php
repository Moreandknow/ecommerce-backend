        ...
        \DB::transaction(function(){
            ...
            for ($productCount = 1; $productCount <= 100; $productCount++) { 
                ...
                $payload = [
                    ...
                    'description' => 'Deskripsi produk ' . $productCount . '. Lorem ipsum dolor sit amet consectetur, adipisicing elit',
                    'stock' => rand(1, 100), 
                    'weight' => rand(1, 100), 
                    'length' => rand(1, 100), 
                    'width' => rand(1, 100), 
                    ...
                    'reviews' => [
                        [
                            ...
                            'variations' => 'Warna: Hijau, Ukurang: XL',
                            'description' => 'Produk sangat bagus, pengiriman cepat!',
                            'attachments' => [
                                'attachment1.jpg',
                                'attachment2.jpg',
                                'attachment3.jpg',
